...
private:
    ...
    unsigned int animation_counter_1 = 0, animation_counter_2 = 0, animation_counter = 6, animation_counter_3 = 0, counter = 0, animation_counter_4 = 7;
...
public:
    ...
    void seguimiento_mov(QVector2D pos_personaje, QTimer *timerSeguimiento, QTimer *timerExplosion, QTimer *timerMuerte);
    ...
    void explosion(QTimer *timerExplosion);
