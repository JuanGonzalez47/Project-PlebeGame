...
private:
    qreal x;
    qreal y;
    QPixmap spriteSheet, fondo_nivel_2, pantalla_carga_nivel_2, personaje_principal_mov_r, personaje_principal_mov_l, helicoptero_enemigo, helicoptero_amigo, telefono, llantas, sangre, misiles, lanzamisil, helices, explosion_1, explosion_2, game_over, mensaje, salto_D, salto_I, muerte, firme;
    QPixmap sprit,copy;
    int sprite_x;
    int sprite_y;
    int sprite_width;
